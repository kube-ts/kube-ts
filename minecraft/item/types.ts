import { FieldsConfig as ConfigFields, KubeJsSetter } from '../configs/item';
...
interface ItemCreationResult {
	...
	[KubeJsSetter.rarity](r: string): ItemCreationResult;
...
interface ItemConfig {
	 ...
	 * @helper @kubets/minecraft/constants/groups
	 * @supported true
	 */
